...
private:
	...
	float *lightIntensityModifier, *extinctionCoef;
...
public:
	...
	// Draw Geometry
	inline void Draw( unsigned int matlFlags=MATL_FLAGS_NONE, unsigned int optionFlags=OBJECT_OPTION_NONE, bool matlAlreadySpecified=false )							    
		{ geometry->Draw( this,matlFlags,optionFlags,matlAlreadySpecified ); }
	inline void DrawOnly( unsigned int propertyFlags, unsigned int matlFlags=MATL_FLAGS_NONE, unsigned int optionFlags=OBJECT_OPTION_NONE, bool matlAlreadySpecified=false ) 
