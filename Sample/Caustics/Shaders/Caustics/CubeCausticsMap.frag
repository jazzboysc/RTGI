...
void mainmain()
{
	...
	vec3 receiverPos = texture2D(receiverPositionSampler, getTC(mVPLight, vPositionWorld.xyz)).xyz;
...
void main()
{
	...
	gl_FragData[0] = vec4(receiverPos, 1.0); //vec4(diffuseColor, 1.0) * vec4(intPt,1);
	////
