...
namespace RTGI
{
	...
	struct CVS_FbxImporter : public CVS_ResourceImporter
	{
		...
		{
			glm::mat4 matGlobalTransform;

			glm::mat4 matLclTranslation;
			glm::mat4 matLclRotation;
			glm::mat4 matLclScaling;

			//cquat vecPreRotation; // In radians
			glm::vec3 vecLclTranslation;
			glm::quat vecLclRotation; // In radians
			glm::vec3 vecLclScaling;

			glm::vec3 vecGeoTranslation;
			glm::vec3 vecGeoRotation;
			glm::vec3 vecGeoScaling;
		};
