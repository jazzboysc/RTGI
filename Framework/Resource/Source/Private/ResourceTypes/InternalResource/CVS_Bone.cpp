...
glm::vec3 CVS_Bone::getGlobalPosition(const glm::mat4* _parentGlobalPosition)
{
	glm::vec4 parentTransform;
...
int CVS_Bone::initFromFbxNode(FbxNode* _pNode)
{
	...
	if (attribute)
	{
		...
		case FbxNodeAttribute::eSkeleton:
		{
											...
											// Fill data
											m_color = glm::vec3(boneColor.mRed, boneColor.mGreen, boneColor.mBlue);
