...
void GPUDevice::ComputeShaderDispatch(
	ShaderProgram* program, unsigned int globalX,
...
{
	return (this->*_TextureCubeLoadFromSystemMemory)(texture, internalFormat, width,
		height, format, type, mipMap, pixelsPX, pixelsNX, pixelsPY, pixelsNY,
		pixelsPZ, pixelsNZ);
}

void GPUDevice::Texture3DUpdateFromPixelBuffer(
	Texture* texture, PixelBuffer* pixelBuffer)
{
	(this->*_Texture3DUpdateFromPixelBuffer)(texture, pixelBuffer);
}

TextureHandle* GPUDevice::Texture3DLoadFromSystemMemory(
	...
	void* pixels)
{
	return (this->*_Texture3DLoadFromSystemMemory)(texture, internalFormat, width,
		height, depth, format, type, pixels);
}

TextureHandle* GPUDevice::Tex2DArrayLoadFromSystemMemory(
	Texture* texture, BufferInternalFormat internalFormat, int width,
	int height, int depth, BufferFormat format, BufferComponentType type,
	void* pixels)
{
	return (this->*_Tex2DArrayLoadFromSystemMemory)(texture, internalFormat, width,
		height, depth, format, type, pixels);
}

void GPUDevice::Texture2DGetImageData(
	Texture* texture, void* dstPixels)
{
	(this->*_Texture2DGetImageData)(texture, dstPixels);
}

void GPUDevice::Texture2DUpdateFromPixelBuffer(
	Texture* texture, PixelBuffer* pixelBuffer)
{
	(this->*_Texture2DUpdateFromPixelBuffer)(texture, pixelBuffer);
}

TextureHandle* GPUDevice::Texture2DLoadFromTextureBuffer(
	Texture* texture, TextureBuffer* textureBuffer,
	BufferInternalFormat internalFormat)
{
	return (this->*_Texture2DLoadFromTextureBuffer)(texture, textureBuffer, internalFormat);
}

TextureHandle* GPUDevice::Texture2DLoadFromSystemMemory(
	Texture* texture, BufferInternalFormat internalFormat, int width,
	int height, BufferFormat format, BufferComponentType type,
	bool mipMap, void* pixels)
{
	return (this->*_Texture2DLoadFromSystemMemory)(texture, internalFormat, width,
		height, format, type, mipMap, pixels);
}

void GPUDevice::Texture1DGetDataFromGPUMemory(
	Texture* texture, void* dstData)
{
	(this->*_Texture1DGetDataFromGPUMemory)(texture, dstData);
}

void GPUDevice::TextureBindToSampler(Texture* texture,
	unsigned int index, SamplerDesc* sampler)
{
	(this->*_TextureBindToSampler)(texture, index, sampler);
}

void GPUDevice::TextureBindToImageUnit(Texture* texture,
...
TextureHandle* GPUDevice::Texture1DLoadFromSystemMemory(
	Texture* texture, BufferInternalFormat internalFormat, int width,
	BufferFormat format, BufferComponentType type, void* pixels)
{
	return (this->*_Texture1DLoadFromSystemMemory)(texture, internalFormat, width,
		format, type, pixels);
}
...
void GPUDevice::SetUniformValueFloat2(ShaderUniform* uniform, const float* value)
{
...
void GPUDevice::SetUniformValueVec3(ShaderUniform* uniform, const glm::vec3* value)
{
	(this->*_SetUniformValueVec3)(uniform, value);
}

void GPUDevice::SetUniformValueMat4(ShaderUniform* uniform, const glm::mat4* value)
{
